...
<div className={"flex flex-col mt-[-10%] space-y-4 lg:text-sm"} >
 ...
 <span><input id="phone-number" type="text" placeholder="074***********" className={"max-sm:w-[200px] gradient-border py-1"} /></span>
    ...
    <button onClick={()=>{HandlePhoneNumber('phone-number')}} className={"zoe-button px-2 py-2 rounded-full bg-primary text-primary-foreground font-medium
  transition-all duration-300 hover:shadow-[0_0_10px_rgba(139,92,246,0.5)]
  hover:scale-105 active:scale-95"} >{initiate?<CircleNotch size={20.0} className="ml-[50%] animate-spin " /> :'Initiate'}</button>
</div>
     </div>
